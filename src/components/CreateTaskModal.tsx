...
import { createTask } from '../firebase/sessionApi'
...
export function CreateTaskModal({ open, onClose, sessionId, participant }: Props) {
  const db = getDb()
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 p-4 sm:items-center">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-5 py-5">
          ...
          <div>
            <label htmlFor="task-desc" className="block text-sm font-medium text-zinc-700">
              Description
            </label>
            <textarea
              id="task-desc"
          ...
          <div>
            <label htmlFor="task-priority" className="block text-sm font-medium text-zinc-700">
              Priority
            </label>
            <select
              id="task-priority"
